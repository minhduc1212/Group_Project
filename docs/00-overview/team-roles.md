...
Mỗi thành viên làm việc song song từ tuần 1 thông qua **hợp đồng giao diện (contract)** chốt trước — không phải chờ nhau theo trình tự. Xem cơ chế chi tiết ở [contract-first-workflow.md](../01-workflow/contract-first-workflow.md).
