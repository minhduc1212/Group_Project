...
git clone <repo-url>
cd travel-ai
cp .env.example .env      # điền các key cần thiết, hỏi Backend Lead nếu thiếu key dev
...
4. Viết test theo [testing-guide.md](docs/02-standards/testing-guide.md), chạy `npm run lint && npm run test` trước khi push.
...
- ❌ Đổi schema DB mà không báo AI Engineer + Integration Dev
